...
fn create_prefix_lv2_1() {
    let prefix = url_prefix::create_prefix(Protocol::HTTP, "magiclen.org", Some(8000), None::<String>);
...
fn create_prefix_lv2_2() {
    let prefix = url_prefix::create_prefix(Protocol::HTTPS, "magiclen.org", Some(8100), None::<String>);
...
fn create_prefix_lv2_3() {
    let prefix = url_prefix::create_prefix(Protocol::FTP, "magiclen.org", Some(8200), None::<String>);
...
fn create_prefix_lv3_1() {
    let prefix = url_prefix::create_prefix(Protocol::HTTP, "magiclen.org", Some(80), None::<String>);
...
fn create_prefix_lv3_2() {
    let prefix = url_prefix::create_prefix(Protocol::HTTPS, "magiclen.org", Some(443), None::<String>);
